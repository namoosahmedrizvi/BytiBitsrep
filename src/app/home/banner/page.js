...
<Image src='/images/Spring.png' className='BanSpring' alt='Spring' width={100} height={150} />
</div>

<div className='col-lg-2 col-md-12 col-12'>

<Image src="/images/Rectangle.png" className='RectBan' alt='RectBan' width={100} height={100} />
...
{/* <Link href="/emailus" legacyBehavior>
     <a className="nav-link" aria-current="page"> */}
                <Link href="/#ContactUs"  aria-current="page"><button type='button' className='btn btn-lg btn-dark ReBtn'>Reach Out</button></Link>
     {/* </a>
   </Link> */}
...
<div className="row ImgRL">
             ...
             <div className="col-12 col-md-12 col-lg-3 text-center imgSet">
               ...
               <Image src="/images/LeftImg.png" className='LeftImg img-fluid' alt='img' width={264} height={264} />
             </div>
                 
             <div className="col-12 col-md-12 col-lg-4 text-center"></div>
             <div className="col-12 col-md-12 col-lg-4 text-center imgSet">
               
               <Image src='/images/RightImg.png' className='RightImg img-fluid' alt='img' width={264} height={264} />
             </div>
